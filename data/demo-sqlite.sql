-- SQLite copy of the ChatBI demo datasource.
--
-- Usage:
--   sqlite3 data/demo-sales.sqlite < data/demo-sqlite.sql
--
-- This is useful for quickly inspecting the demo data. ChatBI datasource
-- execution currently targets PostgreSQL, so use demo-postgres.sql for
-- end-to-end ChatBI tests.
...
CREATE TABLE order_items (
    ...
    gross_amount REAL GENERATED ALWAYS AS (quantity * unit_price) STORED,
    net_amount REAL GENERATED ALWAYS AS (quantity * unit_price - discount_amount) STORED
);
